...
class Storage(LabelFrame):
    ...
    def _load_page(self):
        ...
        self.pageLabel.config(text=f"Page {self.currentPage + 1} of {self.page_count()}")
    ...
    def page_count(self):
        return max(1, (len(self.storageData) + self.ITEMS_PER_PAGE - 1) // self.ITEMS_PER_PAGE)
    ...
    def getAllItems(self):
        ...
        return self.storageData  # Return the entire storage data, not just selected items