...
def writeInventoryItems(fileLines: list, chapter: int, newData: dict, chapterConfig: dict):
    ...
    if chapter == 1:
        ...
        equipmentSectionStart = itemSectionEnd + 2  # Skip the unused item/key item pair.
